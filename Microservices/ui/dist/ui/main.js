...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.login = function (admin) {
        if (admin) {
            return this.http.get(this.endpoint + "/auth/login/admin");
        }
        else {
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.login = function (admin) {
        var _this = this;
        this.apiService.login(admin).subscribe(function (jwt) {
            _this.jwt = jwt;
        });
    };
...
module.exports = __webpack_require__(/*! /Users/tsolley/Documents/Courseware/Microservices/ui/src/main.ts */"./src/main.ts");
